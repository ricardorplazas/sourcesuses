...
$$Equity \ Value = EV - Total \ Debt - Preferred \ Stock - Minority \ Interest + Cash \ \& \ Equivalents$$
...
- **Debt, Preferred Stock, Minority Interest:**
  - **Added (EqV → EV):** These represent claims on the company's assets/operations by capital providers other than common equity holders. Adding them to Equity Value incorporates _all_ claims, resulting in the total value of the enterprise operations funded by all providers, making EV capital structure neutral.
...
- Structuring [[Mergers & Acquisitions (M&A)|M&A transactions]] (determining the equity purchase price).
- Performing valuation comparisons between firms with differing [[Capital Structure|capital structures]].
