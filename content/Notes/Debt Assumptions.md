> [!abstract] Definition
> Debt assumptions refer to the inputs used to define the structure, terms, and sizing of debt financing. These assumptions directly inform the [[Sources and Uses]] schedule and drive key elements of the post-transaction capital structure and cash flow profile.
...
- **[[Financing Fees]] and [[Original Issue Discount|OID]]**: One-time costs related to arranging the debt, which are capitalized and amortized over the life of the loan.

These inputs flow through to the [[Debt Schedule]] and drive [[interest expense]], cash flow availability, and [[mandatory repayment]] capacity in the [[Leveraged Buyout|model]].