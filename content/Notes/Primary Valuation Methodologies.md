...
1.  **[[Intrinsic Valuation (DCF Analysis)]]**:
    - **Approach**: Values a company based on the net present value (NPV) of its projected future [[Free Cash Flow (FCF)|free cash flows]], discounted back to the present using an appropriate discount rate ([[WACC]] or [[Cost of Equity (Ke)]]).
...
3.  **[[Precedent Transaction Analysis (Transaction Comps)]]**:
