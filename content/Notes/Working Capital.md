...
## Formulas
* **Basic Definition**: $Working \ Capital = Current \ Assets - Current \ Liabilities$ 
* **Operational Definition (NWC / Operating WC)**: Often more practical for analysis, focusing purely on operations:
    ...
    * *Rationale for Exclusions*: Cash is typically excluded as WC changes *explain* cash movements, rather than being an input. Short-term debt is excluded as it relates to [[Cash Flow Statement Sections (Indirect Method)|financing activities]], not core operations.
